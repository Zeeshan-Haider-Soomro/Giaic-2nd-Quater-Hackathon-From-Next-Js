...
import { LocateFixedIcon, PhoneCall, WorkflowIcon } from "lucide-react";
          ...
          {[
            {
              ...
              title: "Address",
              desc: "Gulistan E Johar, Karchi, Sindh, Pakistan",
            },
            {
              title: "Phone",
              icon: <PhoneCall />,
              desc: "Mobile: 03202727926",
            },
            {
              title: "Working Time",
              icon: <WorkflowIcon />,
              desc: "Monday-Friday: 9:00 AM - 05:00 PM\nSaturday-Sunday: 9:00 AM - 05:00 PM",
            },
          ].map((info, index) => (
